...
class Processor(Iface, TProcessor):
  ...
  def process_addComment(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = addComment_result()
    result.success = self._handler.addComment(args.comm)
...
class addComment_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'comm', (TComment.ttypes.TComment, TComment.ttypes.TComment.thrift_spec), None, ), # 1
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.comm = TComment.ttypes.TComment()

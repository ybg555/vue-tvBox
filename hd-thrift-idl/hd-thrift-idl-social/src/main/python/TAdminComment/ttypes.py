...
class TAdminComment:
  ...
  thrift_spec = (
    ...
    (10, TType.STRING, 'mobile', None, None, ), # 10
    (11, TType.STRING, 'toNickName', None, None, ), # 11
    (12, TType.STRING, 'toMobile', None, None, ), # 12
    (13, TType.I64, 'toUserId', None, None, ), # 13
  )

  def __init__(self, id=None, postId=None, userId=None, nickName=None, avatarUrl=None, pid=None, status=None, content=None, createTime=None, mobile=None, toNickName=None, toMobile=None, toUserId=None,):
    self.id = id
    self.postId = postId
    self.userId = userId
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.toMobile = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 13:
        if ftype == TType.I64:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('TAdminComment')
    ...
    if self.mobile is not None:
      oprot.writeFieldBegin('mobile', TType.STRING, 10)
      oprot.writeString(self.mobile)
      oprot.writeFieldEnd()
    if self.toNickName is not None:
      oprot.writeFieldBegin('toNickName', TType.STRING, 11)
      oprot.writeString(self.toNickName)
      oprot.writeFieldEnd()
    if self.toMobile is not None:
      oprot.writeFieldBegin('toMobile', TType.STRING, 12)
      oprot.writeString(self.toMobile)
      oprot.writeFieldEnd()
    if self.toUserId is not None:
      oprot.writeFieldBegin('toUserId', TType.I64, 13)
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.toMobile)

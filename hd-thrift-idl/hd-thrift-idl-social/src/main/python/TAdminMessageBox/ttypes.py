...
class TAdminMessageBox:
  ...
  thrift_spec = (
    ...
    (6, TType.STRING, 'avatarUrl', None, None, ), # 6
  ...
  def __init__(self, id=None, type=None, postId=None, userId=None, nickName=None, avatarUrl=None, toUserId=None, status=None, createTime=None, content=None,):
    self.id = id
    self.type = type
    self.postId = postId
    self.userId = userId
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('TAdminMessageBox')

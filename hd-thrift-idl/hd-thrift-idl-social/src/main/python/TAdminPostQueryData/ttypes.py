...
class TAdminPostQueryData:
  ...
  thrift_spec = (
    ...
    (5, TType.LIST, 'dataList', (TType.STRUCT,(TAdminPost.ttypes.TAdminPost, TAdminPost.ttypes.TAdminPost.thrift_spec)), None, ), # 5
  )
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i4 in xrange(_size0):
            _elem5 = TAdminPost.ttypes.TAdminPost()
            _elem5.read(iprot)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('TAdminPostQueryData')

...
class TAdminCommentQueryData:
  ...
  thrift_spec = (
    ...
    (5, TType.LIST, 'dataList', (TType.STRUCT,(TAdminComment.ttypes.TAdminComment, TAdminComment.ttypes.TAdminComment.thrift_spec)), None, ), # 5
  )
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i4 in xrange(_size0):
            _elem5 = TAdminComment.ttypes.TAdminComment()
            _elem5.read(iprot)

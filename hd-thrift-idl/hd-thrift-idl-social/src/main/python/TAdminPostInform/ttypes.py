...
class TAdminPostInform:
  ...
  def __init__(self, id=None, postId=None, userId=None, nickName=None, avatarUrl=None, content=None, createTime=None, mobile=None,):
    self.id = id
    self.postId = postId
    self.userId = userId
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('TAdminPostInform')

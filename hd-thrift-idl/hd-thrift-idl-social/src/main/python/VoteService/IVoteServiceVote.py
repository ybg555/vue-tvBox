...
class Client(Iface):
  ...
  def recv_vote(self):
    ...
    raise TApplicationException(TApplicationException.MISSING_RESULT, "vote failed: unknown result");
...
class Processor(Iface, TProcessor):
  ...
  def process_vote(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = vote_result()
    result.success = self._handler.vote(args.params)

...
ISocialAdminServiceDeleteAdminCommentClient = function(input, output) {
    this.input = input;
...
ISocialAdminServiceDeleteAdminCommentClient.prototype.deleteAdminComment = function(id, callback) {
  this.send_deleteAdminComment(id, callback); 
  if (!callback) {
    return this.recv_deleteAdminComment();
  }
};

ISocialAdminServiceDeleteAdminCommentClient.prototype.send_deleteAdminComment = function(id, callback) {
  this.output.writeMessageBegin('deleteAdminComment', Thrift.MessageType.CALL, this.seqid);
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_deleteAdminComment();
      } catch (e) {
        result = e;
      }
      callback(result);
...
ISocialAdminServiceDeleteAdminCommentClient.prototype.recv_deleteAdminComment = function() {
  ...
  throw 'deleteAdminComment failed: unknown result';
};

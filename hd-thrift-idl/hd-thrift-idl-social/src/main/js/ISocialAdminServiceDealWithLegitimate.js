...
ISocialAdminServiceDealWithLegitimateClient = function(input, output) {
    this.input = input;
...
ISocialAdminServiceDealWithLegitimateClient.prototype.dealWithLegitimate = function(postId, callback) {
  this.send_dealWithLegitimate(postId, callback); 
  if (!callback) {
    return this.recv_dealWithLegitimate();
  }
};

ISocialAdminServiceDealWithLegitimateClient.prototype.send_dealWithLegitimate = function(postId, callback) {
  this.output.writeMessageBegin('dealWithLegitimate', Thrift.MessageType.CALL, this.seqid);
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_dealWithLegitimate();
      } catch (e) {
        result = e;
      }
      callback(result);
...
ISocialAdminServiceDealWithLegitimateClient.prototype.recv_dealWithLegitimate = function() {
  ...
  throw 'dealWithLegitimate failed: unknown result';
};

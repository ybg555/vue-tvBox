...
IVoteServiceVoteClient = function(input, output) {
    this.input = input;
...
IVoteServiceVoteClient.prototype.vote = function(params, callback) {
  this.send_vote(params, callback); 
  if (!callback) {
    return this.recv_vote();
  }
};

IVoteServiceVoteClient.prototype.send_vote = function(params, callback) {
  this.output.writeMessageBegin('vote', Thrift.MessageType.CALL, this.seqid);
...
IVoteServiceVoteClient.prototype.recv_vote = function() {
  ...
  throw 'vote failed: unknown result';
};

...
ISocialServiceCancelActivityApplyClient = function(input, output) {
    this.input = input;
...
ISocialServiceCancelActivityApplyClient.prototype.cancelActivityApply = function(postId, callback) {
  this.send_cancelActivityApply(postId, callback); 
  if (!callback) {
    return this.recv_cancelActivityApply();
  }
};

ISocialServiceCancelActivityApplyClient.prototype.send_cancelActivityApply = function(postId, callback) {
  this.output.writeMessageBegin('cancelActivityApply', Thrift.MessageType.CALL, this.seqid);
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_cancelActivityApply();
      } catch (e) {
        result = e;
      }
      callback(result);
...
ISocialServiceCancelActivityApplyClient.prototype.recv_cancelActivityApply = function() {
  ...
  throw 'cancelActivityApply failed: unknown result';
};

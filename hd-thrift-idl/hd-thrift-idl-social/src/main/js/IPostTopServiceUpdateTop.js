...
IPostTopServiceUpdateTopClient = function(input, output) {
    this.input = input;
...
IPostTopServiceUpdateTopClient.prototype.updateTop = function(params, callback) {
  this.send_updateTop(params, callback); 
  if (!callback) {
    return this.recv_updateTop();
  }
};

IPostTopServiceUpdateTopClient.prototype.send_updateTop = function(params, callback) {
  this.output.writeMessageBegin('updateTop', Thrift.MessageType.CALL, this.seqid);
...
IPostTopServiceUpdateTopClient.prototype.recv_updateTop = function() {
  ...
  throw 'updateTop failed: unknown result';
};

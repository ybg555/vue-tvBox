...
ISocialAdminServiceDeletePostInformFromPostIdClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
ISocialAdminServiceDeletePostInformFromPostIdClient.prototype.seqid = function() { return this._seqid; }
ISocialAdminServiceDeletePostInformFromPostIdClient.prototype.new_seqid = function() { return this._seqid += 1; }
ISocialAdminServiceDeletePostInformFromPostIdClient.prototype.deletePostInformFromPostId = function(postId, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_deletePostInformFromPostId(postId);
...
ISocialAdminServiceDeletePostInformFromPostIdClient.prototype.send_deletePostInformFromPostId = function(postId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('deletePostInformFromPostId', Thrift.MessageType.CALL, this.seqid());
...
ISocialAdminServiceDeletePostInformFromPostIdClient.prototype.recv_deletePostInformFromPostId = function(input,mtype,rseqid) {
  ...
  return callback('deletePostInformFromPostId failed: unknown result');
};
ISocialAdminServiceDeletePostInformFromPostIdProcessor = exports.Processor = function(handler) {
  this._handler = handler
}
ISocialAdminServiceDeletePostInformFromPostIdProcessor.prototype.process = function(input, output) {
...
ISocialAdminServiceDeletePostInformFromPostIdProcessor.prototype.process_deletePostInformFromPostId = function(seqid, input, output) {
  var args = new ISocialAdminServiceDeletePostInformFromPostId_deletePostInformFromPostId_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.deletePostInformFromPostId.length === 1) {
    Q.fcall(this._handler.deletePostInformFromPostId, args.postId)
      .then(function(result) {
        var result = new ISocialAdminServiceDeletePostInformFromPostId_deletePostInformFromPostId_result({success: result});
        output.writeMessageBegin("deletePostInformFromPostId", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new ISocialAdminServiceDeletePostInformFromPostId_deletePostInformFromPostId_result(err);
        output.writeMessageBegin("deletePostInformFromPostId", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.deletePostInformFromPostId(args.postId,  function (err, result) {
      var result = new ISocialAdminServiceDeletePostInformFromPostId_deletePostInformFromPostId_result((err != null ? err : {success: result}));
      output.writeMessageBegin("deletePostInformFromPostId", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();

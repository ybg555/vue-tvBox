...
TAdminPost = module.exports.TAdminPost = function(args) {
  this.id = null;
  this.userId = null;
  this.nickName = null;
  this.avatarUrl = null;
  ...
  if (args) {
    ...
    if (args.cityCommunities !== undefined) {
      this.cityCommunities = args.cityCommunities;
    }
    ...
    if (args.informStatus !== undefined) {
      this.informStatus = args.informStatus;
    }
    if (args.notify !== undefined) {
      this.notify = args.notify;
    }
    if (args.isConform !== undefined) {
      this.isConform = args.isConform;
    }
  }
};
TAdminPost.prototype = {};
TAdminPost.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 9:
      if (ftype == Thrift.Type.STRING) {
        this.labelName = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 14:
      if (ftype == Thrift.Type.I32) {
        this.praiseCount = input.readI32();
      } else {
        input.skip(ftype);
      }
      break;
      case 15:
      if (ftype == Thrift.Type.I32) {
        this.commentCount = input.readI32();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i5 = 0; _i5 < _size0; ++_i5)
        {
          ...
          this.cityCommunities.push(elem6);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      case 23:
      if (ftype == Thrift.Type.I32) {
        this.informStatus = input.readI32();
      } else {
        input.skip(ftype);
      }
      break;
...
TAdminPost.prototype.write = function(output) {
  output.writeStructBegin('TAdminPost');
  ...
  if (this.browse !== null && this.browse !== undefined) {
    output.writeFieldBegin('browse', Thrift.Type.I32, 10);
    output.writeI32(this.browse);
    output.writeFieldEnd();
  }
  if (this.imageUrl !== null && this.imageUrl !== undefined) {
    output.writeFieldBegin('imageUrl', Thrift.Type.STRING, 11);
  ...
  if (this.mark !== null && this.mark !== undefined) {
    output.writeFieldBegin('mark', Thrift.Type.STRING, 13);
    output.writeString(this.mark);
    output.writeFieldEnd();
  }
  if (this.praiseCount !== null && this.praiseCount !== undefined) {
    output.writeFieldBegin('praiseCount', Thrift.Type.I32, 14);
    output.writeI32(this.praiseCount);
    output.writeFieldEnd();
  }
  if (this.commentCount !== null && this.commentCount !== undefined) {
    output.writeFieldBegin('commentCount', Thrift.Type.I32, 15);
    output.writeI32(this.commentCount);
    output.writeFieldEnd();
  }
  if (this.createTime !== null && this.createTime !== undefined) {
    output.writeFieldBegin('createTime', Thrift.Type.I64, 16);
    output.writeI64(this.createTime);
    output.writeFieldEnd();
  }
  if (this.labelType !== null && this.labelType !== undefined) {
    output.writeFieldBegin('labelType', Thrift.Type.I32, 17);
    output.writeI32(this.labelType);
    output.writeFieldEnd();
  }
  if (this.mobile !== null && this.mobile !== undefined) {
    output.writeFieldBegin('mobile', Thrift.Type.STRING, 18);
    output.writeString(this.mobile);
    output.writeFieldEnd();
  }
  if (this.cityCommunities !== null && this.cityCommunities !== undefined) {
    output.writeFieldBegin('cityCommunities', Thrift.Type.LIST, 19);
    output.writeListBegin(Thrift.Type.STRING, this.cityCommunities.length);
    for (var iter7 in this.cityCommunities)
    {
      if (this.cityCommunities.hasOwnProperty(iter7))
      {
        iter7 = this.cityCommunities[iter7];
  ...
  if (this.applyCount !== null && this.applyCount !== undefined) {
    output.writeFieldBegin('applyCount', Thrift.Type.I32, 20);
    output.writeI32(this.applyCount);
    output.writeFieldEnd();
  }
  if (this.inform !== null && this.inform !== undefined) {
    output.writeFieldBegin('inform', Thrift.Type.I32, 21);
    output.writeI32(this.inform);
    output.writeFieldEnd();
  }
  if (this.isDelete !== null && this.isDelete !== undefined) {
    output.writeFieldBegin('isDelete', Thrift.Type.I32, 22);
    output.writeI32(this.isDelete);
    output.writeFieldEnd();
  }
  if (this.informStatus !== null && this.informStatus !== undefined) {
    output.writeFieldBegin('informStatus', Thrift.Type.I32, 23);
    output.writeI32(this.informStatus);
    output.writeFieldEnd();
  }
  if (this.notify !== null && this.notify !== undefined) {
    output.writeFieldBegin('notify', Thrift.Type.I32, 24);
    output.writeI32(this.notify);
    output.writeFieldEnd();
  }
  if (this.isConform !== null && this.isConform !== undefined) {
    output.writeFieldBegin('isConform', Thrift.Type.I32, 25);
    output.writeI32(this.isConform);
    output.writeFieldEnd();
  }

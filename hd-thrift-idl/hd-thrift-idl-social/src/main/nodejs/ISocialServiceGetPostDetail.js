...
ISocialServiceGetPostDetailClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
ISocialServiceGetPostDetailClient.prototype.seqid = function() { return this._seqid; }
ISocialServiceGetPostDetailClient.prototype.new_seqid = function() { return this._seqid += 1; }
ISocialServiceGetPostDetailClient.prototype.getPostDetail = function(params, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_getPostDetail(params);
...
ISocialServiceGetPostDetailClient.prototype.send_getPostDetail = function(params) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getPostDetail', Thrift.MessageType.CALL, this.seqid());
...
ISocialServiceGetPostDetailClient.prototype.recv_getPostDetail = function(input,mtype,rseqid) {
  ...
  return callback('getPostDetail failed: unknown result');
};
ISocialServiceGetPostDetailProcessor = exports.Processor = function(handler) {
  this._handler = handler
}
ISocialServiceGetPostDetailProcessor.prototype.process = function(input, output) {
...
ISocialServiceGetPostDetailProcessor.prototype.process_getPostDetail = function(seqid, input, output) {
  var args = new ISocialServiceGetPostDetail_getPostDetail_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getPostDetail.length === 1) {
    Q.fcall(this._handler.getPostDetail, args.params)
      .then(function(result) {
        var result = new ISocialServiceGetPostDetail_getPostDetail_result({success: result});
        output.writeMessageBegin("getPostDetail", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new ISocialServiceGetPostDetail_getPostDetail_result(err);
        output.writeMessageBegin("getPostDetail", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getPostDetail(args.params,  function (err, result) {
      var result = new ISocialServiceGetPostDetail_getPostDetail_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getPostDetail", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();

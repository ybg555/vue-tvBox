...
IActivityAdminServiceConfirmPrizeListClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
IActivityAdminServiceConfirmPrizeListClient.prototype.seqid = function() { return this._seqid; }
IActivityAdminServiceConfirmPrizeListClient.prototype.new_seqid = function() { return this._seqid += 1; }
...
IActivityAdminServiceConfirmPrizeListClient.prototype.send_confirmPrizeList = function(id) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('confirmPrizeList', Thrift.MessageType.CALL, this.seqid());
...
IActivityAdminServiceConfirmPrizeListClient.prototype.recv_confirmPrizeList = function(input,mtype,rseqid) {
  ...
  return callback('confirmPrizeList failed: unknown result');
};
IActivityAdminServiceConfirmPrizeListProcessor = exports.Processor = function(handler) {
  this._handler = handler
}
IActivityAdminServiceConfirmPrizeListProcessor.prototype.process = function(input, output) {
...
IActivityAdminServiceConfirmPrizeListProcessor.prototype.process_confirmPrizeList = function(seqid, input, output) {
  var args = new IActivityAdminServiceConfirmPrizeList_confirmPrizeList_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.confirmPrizeList.length === 1) {
    Q.fcall(this._handler.confirmPrizeList, args.id)
      .then(function(result) {
        var result = new IActivityAdminServiceConfirmPrizeList_confirmPrizeList_result({success: result});
        output.writeMessageBegin("confirmPrizeList", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new IActivityAdminServiceConfirmPrizeList_confirmPrizeList_result(err);
        output.writeMessageBegin("confirmPrizeList", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.confirmPrizeList(args.id,  function (err, result) {
      var result = new IActivityAdminServiceConfirmPrizeList_confirmPrizeList_result((err != null ? err : {success: result}));
      output.writeMessageBegin("confirmPrizeList", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();

...
TPost = module.exports.TPost = function(args) {
  this.id = null;
  this.userId = null;
  this.nickName = null;
  this.avatarUrl = null;
...
TPost.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 17:
      if (ftype == Thrift.Type.I32) {
        this.activityCount = input.readI32();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 21:
      if (ftype == Thrift.Type.BOOL) {
        this.myActivity = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;

...
class TComment {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['toAvatarUrl'])) {
        $this->toAvatarUrl = $vals['toAvatarUrl'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 9:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->toAvatarUrl);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->toNickName !== null) {
      $xfer += $output->writeFieldBegin('toNickName', TType::STRING, 8);
      $xfer += $output->writeString($this->toNickName);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->toAvatarUrl !== null) {
      $xfer += $output->writeFieldBegin('toAvatarUrl', TType::STRING, 9);
      $xfer += $output->writeString($this->toAvatarUrl);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->status !== null) {
    ...
    if ($this->createTime !== null) {
      $xfer += $output->writeFieldBegin('createTime', TType::I64, 12);

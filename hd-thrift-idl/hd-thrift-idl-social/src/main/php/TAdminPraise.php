...
class TAdminPraise {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 6:
          if ($ftype == TType::I32) {
            $xfer += $input->readI32($this->postUserId);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TAdminPraise');
    if ($this->id !== null) {
    ...
    if ($this->postUserId !== null) {
      $xfer += $output->writeFieldBegin('postUserId', TType::I32, 6);
      $xfer += $output->writeI32($this->postUserId);
      $xfer += $output->writeFieldEnd();
    }

...
- (id) initWithId: (int32_t) id postId: (int32_t) postId userId: (int64_t) userId nickName: (NSString *) nickName avatarUrl: (NSString *) avatarUrl pid: (int32_t) pid toUserId: (int64_t) toUserId toNickName: (NSString *) toNickName toAvatarUrl: (NSString *) toAvatarUrl status: (int32_t) status content: (NSString *) content createTime: (int64_t) createTime
{
  ...
  __toAvatarUrl = [toAvatarUrl retain_stub];
  __toAvatarUrl_isset = YES;
  __status = status;
  __status_isset = YES;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"toAvatarUrl"])
  {
    __toAvatarUrl = [[decoder decodeObjectForKey: @"toAvatarUrl"] retain_stub];
    __toAvatarUrl_isset = YES;
  }
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__toAvatarUrl_isset)
  {
    [encoder encodeObject: __toAvatarUrl forKey: @"toAvatarUrl"];
  }
  if (__status_isset)
  {
...
- (NSString *) toAvatarUrl {
  return [[__toAvatarUrl retain_stub] autorelease_stub];
}

- (void) setToAvatarUrl: (NSString *) toAvatarUrl {
  [toAvatarUrl retain_stub];
  [__toAvatarUrl release_stub];
  __toAvatarUrl = toAvatarUrl;
  __toAvatarUrl_isset = YES;
}

- (BOOL) toAvatarUrlIsSet {
  return __toAvatarUrl_isset;
}

- (void) unsetToAvatarUrl {
  [__toAvatarUrl release_stub];
  __toAvatarUrl = nil;
  __toAvatarUrl_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 9:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setToAvatarUrl: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TComment"];
  if (__id_isset) {
  ...
  if (__toNickName_isset) {
    if (__toNickName != nil) {
      [outProtocol writeFieldBeginWithName: @"toNickName" type: TType_STRING fieldID: 8];
      [outProtocol writeString: __toNickName];
      [outProtocol writeFieldEnd];
    }
  }
  if (__toAvatarUrl_isset) {
    if (__toAvatarUrl != nil) {
      [outProtocol writeFieldBeginWithName: @"toAvatarUrl" type: TType_STRING fieldID: 9];
      [outProtocol writeString: __toAvatarUrl];
      [outProtocol writeFieldEnd];
    }
  }
  if (__status_isset) {
  ...
  if (__content_isset) {
    if (__content != nil) {
      [outProtocol writeFieldBeginWithName: @"content" type: TType_STRING fieldID: 11];
      [outProtocol writeString: __content];
      [outProtocol writeFieldEnd];
    }
  }
  if (__createTime_isset) {
    [outProtocol writeFieldBeginWithName: @"createTime" type: TType_I64 fieldID: 12];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TComment("];
  [ms appendString: @"id:"];
  ...
  [ms appendString: @",toAvatarUrl:"];
  [ms appendFormat: @"\"%@\"", __toAvatarUrl];
...
@implementation TCommentConstants
+ (void) initialize {
}
@end

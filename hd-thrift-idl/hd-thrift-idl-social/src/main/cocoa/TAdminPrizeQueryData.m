...
@implementation TAdminPrizeQueryData
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TAdminPrizeQueryData"];
  if (__totalCount_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TAdminPrizeQueryData("];
...
@implementation TAdminPrizeQueryDataConstants
+ (void) initialize {
}
@end

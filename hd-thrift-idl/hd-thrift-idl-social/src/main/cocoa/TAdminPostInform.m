...
@implementation TAdminPostInform
...
- (id) initWithId: (int32_t) id postId: (int32_t) postId userId: (int64_t) userId nickName: (NSString *) nickName avatarUrl: (NSString *) avatarUrl content: (NSString *) content createTime: (int64_t) createTime mobile: (NSString *) mobile
{
  self = [super init];
  __id = id;
  __id_isset = YES;
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TAdminPostInform"];
  if (__id_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TAdminPostInform("];
  [ms appendString: @"id:"];
...
@implementation TAdminPostInformConstants
+ (void) initialize {
}
@end

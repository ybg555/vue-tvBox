...
@interface TMessageBox : NSObject <TBase, NSCoding> {
  int32_t __id;
  int32_t __type;
  int32_t __postId;
  NSString * __postImageUrl;
  NSString * __postContent;
  int64_t __userId;
  NSString * __nickName;
  ...
  BOOL __type_isset;
  BOOL __postId_isset;
  BOOL __postImageUrl_isset;
  BOOL __postContent_isset;
  BOOL __userId_isset;
...
@property (nonatomic, retain, getter=postImageUrl, setter=setPostImageUrl:) NSString * postImageUrl;
@property (nonatomic, retain, getter=postContent, setter=setPostContent:) NSString * postContent;
...
@interface TMessageBoxConstants : NSObject {
}
@end

...
@implementation TAdminPostQueryData
    ...
    switch (fieldID)
    {
      ...
      case 5:
        if (fieldType == TType_LIST) {
          ...
          {
            TAdminPost *_elem2 = [[TAdminPost alloc] init];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TAdminPostQueryData"];
  if (__totalCount_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TAdminPostQueryData("];
...
@implementation TAdminPostQueryDataConstants
+ (void) initialize {
}
@end

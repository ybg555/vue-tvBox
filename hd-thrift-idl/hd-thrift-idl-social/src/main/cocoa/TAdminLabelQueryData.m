...
@implementation TAdminLabelQueryData
    ...
    switch (fieldID)
    {
      ...
      case 5:
        if (fieldType == TType_LIST) {
          ...
          {
            TAdminLabel *_elem2 = [[TAdminLabel alloc] init];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TAdminLabelQueryData"];
  if (__totalCount_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TAdminLabelQueryData("];
...
@implementation TAdminLabelQueryDataConstants
+ (void) initialize {
}
@end

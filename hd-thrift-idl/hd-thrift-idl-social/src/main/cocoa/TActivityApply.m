...
- (id) initWithId: (int32_t) id postId: (int32_t) postId userId: (int64_t) userId nickName: (NSString *) nickName avatarUrl: (NSString *) avatarUrl postUserId: (int64_t) postUserId createTime: (int64_t) createTime
{
  self = [super init];
  __id = id;
  __id_isset = YES;
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TActivityApply"];
  if (__id_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TActivityApply("];
  [ms appendString: @"id:"];
...
@implementation TActivityApplyConstants
+ (void) initialize {
}
@end

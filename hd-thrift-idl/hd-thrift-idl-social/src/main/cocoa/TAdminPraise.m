...
#import "TAdminPraise.h"

@implementation TAdminPraise
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __postUserId = [decoder decodeInt32ForKey: @"postUserId"];
    __postUserId_isset = YES;
  }
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  {
    [encoder encodeInt32: __postUserId forKey: @"postUserId"];
  }
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TAdminPraise"];
  if (__id_isset) {
  ...
  if (__postUserId_isset) {
    [outProtocol writeFieldBeginWithName: @"postUserId" type: TType_I32 fieldID: 6];
    [outProtocol writeI32: __postUserId];
    [outProtocol writeFieldEnd];
  }
  if (__createTime_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TAdminPraise("];
  [ms appendString: @"id:"];
  ...
  [ms appendFormat: @"%i", __postUserId];
...
@implementation TAdminPraiseConstants
+ (void) initialize {
}
@end

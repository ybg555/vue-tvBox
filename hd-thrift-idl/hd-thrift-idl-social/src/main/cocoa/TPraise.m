...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TPraise"];
  if (__id_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TPraise("];
  [ms appendString: @"id:"];
...
@implementation TPraiseConstants
+ (void) initialize {
}
@end

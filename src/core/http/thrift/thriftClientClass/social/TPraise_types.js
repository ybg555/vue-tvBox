var Thrift = require('../../Thrift.js');var TPraise ;//
...
TPraise.prototype = {};
TPraise.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 6:
      if (ftype == Thrift.Type.I32) {
        this.postUserId = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
TPraise.prototype.write = function(output) {
  output.writeStructBegin('TPraise');
...
;module.exports = { 'TPraise' : TPraise }
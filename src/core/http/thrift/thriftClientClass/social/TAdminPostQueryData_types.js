var Thrift = require('../../Thrift.js');var TAdminPost = require('./TAdminPost_types.js')['TAdminPost'];var TAdminPostQueryData ;//
...
TAdminPostQueryData = function(args) {
...
TAdminPostQueryData.prototype = {};
TAdminPostQueryData.prototype.read = function(input) {
...
TAdminPostQueryData.prototype.write = function(output) {
  output.writeStructBegin('TAdminPostQueryData');
...
;module.exports = { 'TAdminPostQueryData' : TAdminPostQueryData }
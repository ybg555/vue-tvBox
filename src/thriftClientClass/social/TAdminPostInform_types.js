var Thrift = require('../../Thrift.js');var TAdminPostInform ;//
...
TAdminPostInform = function(args) {
  this.id = null;
  this.postId = null;
  this.userId = null;
  this.nickName = null;
...
TAdminPostInform.prototype = {};
TAdminPostInform.prototype.read = function(input) {
...
TAdminPostInform.prototype.write = function(output) {
  output.writeStructBegin('TAdminPostInform');
...
;module.exports = { 'TAdminPostInform' : TAdminPostInform }
var Thrift = require('../../Thrift.js');var TMessageBox ;//
...
TMessageBox = function(args) {
  ...
  if (args) {
    ...
    if (args.postImageUrl !== undefined) {
      this.postImageUrl = args.postImageUrl;
    }
    if (args.postContent !== undefined) {
      this.postContent = args.postContent;
    }
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRING) {
        this.postImageUrl = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.postContent = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
TMessageBox.prototype.write = function(output) {
  ...
  if (this.postImageUrl !== null && this.postImageUrl !== undefined) {
    output.writeFieldBegin('postImageUrl', Thrift.Type.STRING, 4);
    output.writeString(this.postImageUrl);
    output.writeFieldEnd();
  }
  if (this.postContent !== null && this.postContent !== undefined) {
    output.writeFieldBegin('postContent', Thrift.Type.STRING, 5);
    output.writeString(this.postContent);
    output.writeFieldEnd();
  }
  ...
  if (this.nickName !== null && this.nickName !== undefined) {
    output.writeFieldBegin('nickName', Thrift.Type.STRING, 7);
    output.writeString(this.nickName);
    output.writeFieldEnd();
  }
  if (this.avatarUrl !== null && this.avatarUrl !== undefined) {
    output.writeFieldBegin('avatarUrl', Thrift.Type.STRING, 8);
    output.writeString(this.avatarUrl);
    output.writeFieldEnd();
  }
  if (this.toUserId !== null && this.toUserId !== undefined) {
    output.writeFieldBegin('toUserId', Thrift.Type.I64, 9);
...
;module.exports = { 'TMessageBox' : TMessageBox }
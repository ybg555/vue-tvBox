var Thrift = require('../../Thrift.js');var TAdminActivityApply ;//
...
TAdminActivityApply = function(args) {
  this.id = null;
  this.postId = null;
  this.userId = null;
  this.nickName = null;
...
TAdminActivityApply.prototype = {};
TAdminActivityApply.prototype.read = function(input) {
...
TAdminActivityApply.prototype.write = function(output) {
  output.writeStructBegin('TAdminActivityApply');
  ...
  if (this.postUserId !== null && this.postUserId !== undefined) {
    output.writeFieldBegin('postUserId', Thrift.Type.I64, 6);
  ...
  if (this.mobile !== null && this.mobile !== undefined) {
    output.writeFieldBegin('mobile', Thrift.Type.STRING, 8);
...
;module.exports = { 'TAdminActivityApply' : TAdminActivityApply }
var Thrift = require('../../Thrift.js');var TAdminPost ;//
...
TAdminPost.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 20:
      if (ftype == Thrift.Type.I32) {
        this.applyCount = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 22:
      if (ftype == Thrift.Type.I32) {
        this.isDelete = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 23:
      if (ftype == Thrift.Type.I32) {
        this.informStatus = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 24:
      if (ftype == Thrift.Type.I32) {
        this.notify = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 25:
      if (ftype == Thrift.Type.I32) {
        this.isConform = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
;module.exports = { 'TAdminPost' : TAdminPost }